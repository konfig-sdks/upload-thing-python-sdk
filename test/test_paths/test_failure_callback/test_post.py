...
from upload_thing_python_sdk.paths.failure_callback import post
from upload_thing_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestFailureCallback(ApiTestMixin, unittest.TestCase):
    """
    FailureCallback unit test stubs
    """
