...
class FileListFilesResponseFilesItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "customId", "key", "name", "status", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "customId", "key", "name", "status", ], str]):
    ...
    ) -> 'FileListFilesResponseFilesItem':
        return super().__new__(
            cls,
            *args,
            name=name,
