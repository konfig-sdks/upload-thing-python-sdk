...
class FileRenameFilesRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def updates() -> typing.Type['FileRenameFilesRequestUpdates']:
                return FileRenameFilesRequestUpdates
            __annotations__ = {
                "updates": updates,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["updates"]) -> 'FileRenameFilesRequestUpdates': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["updates"]) -> 'FileRenameFilesRequestUpdates': ...
