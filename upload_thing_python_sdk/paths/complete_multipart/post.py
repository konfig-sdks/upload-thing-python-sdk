...
from upload_thing_python_sdk.model.multipart_complete_upload_request import MultipartCompleteUploadRequest as MultipartCompleteUploadRequestSchema
from upload_thing_python_sdk.model.multipart_complete_upload_response import MultipartCompleteUploadResponse as MultipartCompleteUploadResponseSchema
...
from upload_thing_python_sdk.model.multipart_complete_upload_request_etags import MultipartCompleteUploadRequestEtags as MultipartCompleteUploadRequestEtagsSchema

from upload_thing_python_sdk.type.multipart_complete_upload_request_etags import MultipartCompleteUploadRequestEtags
from upload_thing_python_sdk.type.err_bad_request import ErrBadRequest
from upload_thing_python_sdk.type.multipart_complete_upload_request import MultipartCompleteUploadRequest
from upload_thing_python_sdk.type.multipart_complete_upload_response import MultipartCompleteUploadResponse
...
from upload_thing_python_sdk.pydantic.multipart_complete_upload_request import MultipartCompleteUploadRequest as MultipartCompleteUploadRequestPydantic
from upload_thing_python_sdk.pydantic.multipart_complete_upload_response import MultipartCompleteUploadResponse as MultipartCompleteUploadResponsePydantic
from upload_thing_python_sdk.pydantic.err_bad_request import ErrBadRequest as ErrBadRequestPydantic
from upload_thing_python_sdk.pydantic.multipart_complete_upload_request_etags import MultipartCompleteUploadRequestEtags as MultipartCompleteUploadRequestEtagsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = MultipartCompleteUploadRequestSchema


request_body_multipart_complete_upload_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = MultipartCompleteUploadResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: MultipartCompleteUploadResponse
...
class BaseApi(api_client.Api):
    ...
    def _complete_upload_mapped_args(
        self,
        file_key: str,
        upload_id: str,
    ...
    async def _acomplete_upload_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/completeMultipart',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_multipart_complete_upload_request.serialize(body, content_type)
...
class CompleteUploadRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acomplete_upload(
        self,
        file_key: str,
        upload_id: str,
        etags: MultipartCompleteUploadRequestEtags,
        ...
        **kwargs,
        ...
        args = self._complete_upload_mapped_args(
            file_key=file_key,
            upload_id=upload_id,
            etags=etags,
        ...
        return await self._acomplete_upload_oapg(
            body=args.body,
...
class CompleteUpload(BaseApi):
    ...
    async def acomplete_upload(
        ...
        validate: bool = False,
        **kwargs,
    ) -> MultipartCompleteUploadResponsePydantic:
        raw_response = await self.raw.acomplete_upload(
            file_key=file_key,
            upload_id=upload_id,
            etags=etags,
            x_uploadthing_version=x_uploadthing_version,
        ...
        if validate:
            return MultipartCompleteUploadResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(MultipartCompleteUploadResponsePydantic, raw_response.body)
    ...
    def complete_upload(
        ...
        raw_response = self.raw.complete_upload(
            file_key=file_key,
            upload_id=upload_id,
            etags=etags,
            x_uploadthing_version=x_uploadthing_version,
