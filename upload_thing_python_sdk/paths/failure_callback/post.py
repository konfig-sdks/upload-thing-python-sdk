...
from upload_thing_python_sdk.model.callback_mark_upload_failed_request import CallbackMarkUploadFailedRequest as CallbackMarkUploadFailedRequestSchema
...
from upload_thing_python_sdk.model.callback_mark_upload_failed_response import CallbackMarkUploadFailedResponse as CallbackMarkUploadFailedResponseSchema

from upload_thing_python_sdk.type.err_bad_request import ErrBadRequest
from upload_thing_python_sdk.type.callback_mark_upload_failed_response import CallbackMarkUploadFailedResponse
from upload_thing_python_sdk.type.callback_mark_upload_failed_request import CallbackMarkUploadFailedRequest
...
from upload_thing_python_sdk.pydantic.callback_mark_upload_failed_request import CallbackMarkUploadFailedRequest as CallbackMarkUploadFailedRequestPydantic
from upload_thing_python_sdk.pydantic.err_bad_request import ErrBadRequest as ErrBadRequestPydantic
from upload_thing_python_sdk.pydantic.callback_mark_upload_failed_response import CallbackMarkUploadFailedResponse as CallbackMarkUploadFailedResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = CallbackMarkUploadFailedRequestSchema


request_body_callback_mark_upload_failed_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CallbackMarkUploadFailedResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CallbackMarkUploadFailedResponse
...
class BaseApi(api_client.Api):
    ...
    def _mark_upload_failed_mapped_args(
        self,
        file_key: str,
        x_uploadthing_version: str,
        upload_id: typing.Optional[typing.Optional[str]] = None,
    ...
    async def _amark_upload_failed_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/failureCallback',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_callback_mark_upload_failed_request.serialize(body, content_type)
...
class MarkUploadFailedRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def amark_upload_failed(
        self,
        file_key: str,
        x_uploadthing_version: str,
        upload_id: typing.Optional[typing.Optional[str]] = None,
        ...
        **kwargs,
        ...
        args = self._mark_upload_failed_mapped_args(
            file_key=file_key,
        ...
        return await self._amark_upload_failed_oapg(
            body=args.body,
    ...
    def mark_upload_failed(
        ...
        return self._mark_upload_failed_oapg(
            body=args.body,
            header_params=args.header,
        )

class MarkUploadFailed(BaseApi):
    ...
    async def amark_upload_failed(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CallbackMarkUploadFailedResponsePydantic:
        raw_response = await self.raw.amark_upload_failed(
            file_key=file_key,
            x_uploadthing_version=x_uploadthing_version,
            upload_id=upload_id,
            x_uploadthing_fe_package=x_uploadthing_fe_package,
        ...
        if validate:
            return CallbackMarkUploadFailedResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CallbackMarkUploadFailedResponsePydantic, raw_response.body)
    ...
    def mark_upload_failed(
        ...
        raw_response = self.raw.mark_upload_failed(
            file_key=file_key,
            x_uploadthing_version=x_uploadthing_version,
            upload_id=upload_id,
            x_uploadthing_fe_package=x_uploadthing_fe_package,
