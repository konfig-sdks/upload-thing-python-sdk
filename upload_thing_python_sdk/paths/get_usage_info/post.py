...
from upload_thing_python_sdk.model.usage_info_get_usage_info_response import UsageInfoGetUsageInfoResponse as UsageInfoGetUsageInfoResponseSchema
...
from upload_thing_python_sdk.type.usage_info_get_usage_info_response import UsageInfoGetUsageInfoResponse
...
from upload_thing_python_sdk.pydantic.usage_info_get_usage_info_response import UsageInfoGetUsageInfoResponse as UsageInfoGetUsageInfoResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = UsageInfoGetUsageInfoResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: UsageInfoGetUsageInfoResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_usage_info_mapped_args(
        self,
    ...
    async def _aget_usage_info_oapg(
        self,
...
class GetUsageInfoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_usage_info(
        self,
        x_uploadthing_version: str,
        x_uploadthing_fe_package: typing.Optional[str] = None,
        x_uploadthing_be_adapter: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_usage_info_mapped_args(
        ...
        return await self._aget_usage_info_oapg(
    ...
    def get_usage_info(
        ...
        return self._get_usage_info_oapg(
            header_params=args.header,
        )

class GetUsageInfo(BaseApi):
    ...
    async def aget_usage_info(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UsageInfoGetUsageInfoResponsePydantic:
        raw_response = await self.raw.aget_usage_info(
            x_uploadthing_version=x_uploadthing_version,
            x_uploadthing_fe_package=x_uploadthing_fe_package,
            x_uploadthing_be_adapter=x_uploadthing_be_adapter,
            **kwargs,
        ...
        if validate:
            return UsageInfoGetUsageInfoResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(UsageInfoGetUsageInfoResponsePydantic, raw_response.body)
    ...
    def get_usage_info(
        ...
        raw_response = self.raw.get_usage_info(
            x_uploadthing_version=x_uploadthing_version,
            x_uploadthing_fe_package=x_uploadthing_fe_package,
            x_uploadthing_be_adapter=x_uploadthing_be_adapter,
        )
