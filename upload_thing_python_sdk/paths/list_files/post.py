...
from upload_thing_python_sdk.model.file_list_files_response import FileListFilesResponse as FileListFilesResponseSchema
from upload_thing_python_sdk.model.file_list_files_request import FileListFilesRequest as FileListFilesRequestSchema

from upload_thing_python_sdk.type.err_bad_request import ErrBadRequest
from upload_thing_python_sdk.type.file_list_files_response import FileListFilesResponse
...
from upload_thing_python_sdk.type.file_list_files_request import FileListFilesRequest
...
from upload_thing_python_sdk.pydantic.file_list_files_request import FileListFilesRequest as FileListFilesRequestPydantic
from upload_thing_python_sdk.pydantic.err_bad_request import ErrBadRequest as ErrBadRequestPydantic
from upload_thing_python_sdk.pydantic.file_list_files_response import FileListFilesResponse as FileListFilesResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = FileListFilesRequestSchema


request_body_file_list_files_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = FileListFilesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FileListFilesResponse
    ...
    async def _alist_files_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/listFiles',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_file_list_files_request.serialize(body, content_type)
...
class ListFiles(BaseApi):
    ...
    async def alist_files(
        ...
        **kwargs,
        ...
        if validate:
            return FileListFilesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FileListFilesResponsePydantic, raw_response.body)
