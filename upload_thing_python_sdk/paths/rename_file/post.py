...
from upload_thing_python_sdk.model.file_update_file_name_request_updates import FileUpdateFileNameRequestUpdates as FileUpdateFileNameRequestUpdatesSchema
from upload_thing_python_sdk.model.file_update_file_name_response import FileUpdateFileNameResponse as FileUpdateFileNameResponseSchema
...
from upload_thing_python_sdk.model.file_update_file_name_request import FileUpdateFileNameRequest as FileUpdateFileNameRequestSchema
...
from upload_thing_python_sdk.type.file_update_file_name_request_updates import FileUpdateFileNameRequestUpdates
from upload_thing_python_sdk.type.err_bad_request import ErrBadRequest
from upload_thing_python_sdk.type.file_update_file_name_request import FileUpdateFileNameRequest
...
from upload_thing_python_sdk.type.file_update_file_name_response import FileUpdateFileNameResponse
...
from upload_thing_python_sdk.pydantic.file_update_file_name_request import FileUpdateFileNameRequest as FileUpdateFileNameRequestPydantic
from upload_thing_python_sdk.pydantic.err_bad_request import ErrBadRequest as ErrBadRequestPydantic
from upload_thing_python_sdk.pydantic.file_update_file_name_request_updates import FileUpdateFileNameRequestUpdates as FileUpdateFileNameRequestUpdatesPydantic
from upload_thing_python_sdk.pydantic.file_update_file_name_response import FileUpdateFileNameResponse as FileUpdateFileNameResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = FileUpdateFileNameRequestSchema


request_body_file_update_file_name_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = FileUpdateFileNameResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FileUpdateFileNameResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_file_name_mapped_args(
        self,
    ...
    async def _aupdate_file_name_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/renameFile',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_file_update_file_name_request.serialize(body, content_type)
...
class UpdateFileNameRaw(BaseApi):
    ...
    async def aupdate_file_name(
        ...
        **kwargs,
        ...
        args = self._update_file_name_mapped_args(
            updates=updates,
        ...
        return await self._aupdate_file_name_oapg(
            body=args.body,
    ...
    def update_file_name(
        ...
        return self._update_file_name_oapg(
            body=args.body,
            header_params=args.header,
        )

class UpdateFileName(BaseApi):
    ...
    async def aupdate_file_name(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FileUpdateFileNameResponsePydantic:
        raw_response = await self.raw.aupdate_file_name(
            updates=updates,
            x_uploadthing_version=x_uploadthing_version,
            x_uploadthing_fe_package=x_uploadthing_fe_package,
            x_uploadthing_be_adapter=x_uploadthing_be_adapter,
        ...
        if validate:
            return FileUpdateFileNameResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FileUpdateFileNameResponsePydantic, raw_response.body)
    ...
    def update_file_name(
        ...
        raw_response = self.raw.update_file_name(
            updates=updates,
            x_uploadthing_version=x_uploadthing_version,
            x_uploadthing_fe_package=x_uploadthing_fe_package,
            x_uploadthing_be_adapter=x_uploadthing_be_adapter,
