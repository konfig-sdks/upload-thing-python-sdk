...
from upload_thing_python_sdk.model.file_rename_files_response import FileRenameFilesResponse as FileRenameFilesResponseSchema
...
from upload_thing_python_sdk.model.file_rename_files_request import FileRenameFilesRequest as FileRenameFilesRequestSchema
from upload_thing_python_sdk.model.file_rename_files_request_updates import FileRenameFilesRequestUpdates as FileRenameFilesRequestUpdatesSchema

from upload_thing_python_sdk.type.err_bad_request import ErrBadRequest
from upload_thing_python_sdk.type.file_rename_files_request import FileRenameFilesRequest
from upload_thing_python_sdk.type.file_rename_files_response import FileRenameFilesResponse
...
from upload_thing_python_sdk.type.file_rename_files_request_updates import FileRenameFilesRequestUpdates
...
from upload_thing_python_sdk.pydantic.file_rename_files_request_updates import FileRenameFilesRequestUpdates as FileRenameFilesRequestUpdatesPydantic
...
from upload_thing_python_sdk.pydantic.file_rename_files_request import FileRenameFilesRequest as FileRenameFilesRequestPydantic
from upload_thing_python_sdk.pydantic.file_rename_files_response import FileRenameFilesResponse as FileRenameFilesResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = FileRenameFilesRequestSchema


request_body_file_rename_files_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = FileRenameFilesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FileRenameFilesResponse
...
class BaseApi(api_client.Api):
    ...
    def _rename_files_mapped_args(
        self,
        updates: FileRenameFilesRequestUpdates,
    ...
    async def _arename_files_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/renameFiles',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_file_rename_files_request.serialize(body, content_type)
...
class RenameFilesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arename_files(
        self,
        updates: FileRenameFilesRequestUpdates,
        x_uploadthing_version: str,
        x_uploadthing_fe_package: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._rename_files_mapped_args(
            updates=updates,
        ...
        return await self._arename_files_oapg(
            body=args.body,
    ...
    def rename_files(
        ...
        return self._rename_files_oapg(
            body=args.body,
            header_params=args.header,
        )

class RenameFiles(BaseApi):
    ...
    async def arename_files(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FileRenameFilesResponsePydantic:
        raw_response = await self.raw.arename_files(
            updates=updates,
            x_uploadthing_version=x_uploadthing_version,
            x_uploadthing_fe_package=x_uploadthing_fe_package,
            x_uploadthing_be_adapter=x_uploadthing_be_adapter,
        ...
        if validate:
            return FileRenameFilesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FileRenameFilesResponsePydantic, raw_response.body)
    ...
    def rename_files(
        ...
        raw_response = self.raw.rename_files(
            updates=updates,
            x_uploadthing_version=x_uploadthing_version,
            x_uploadthing_fe_package=x_uploadthing_fe_package,
            x_uploadthing_be_adapter=x_uploadthing_be_adapter,
