...
from upload_thing_python_sdk.model.file_request_presigned_url404_response import FileRequestPresignedUrl404Response as FileRequestPresignedUrl404ResponseSchema
...
from upload_thing_python_sdk.model.file_request_presigned_url_request import FileRequestPresignedUrlRequest as FileRequestPresignedUrlRequestSchema
from upload_thing_python_sdk.model.file_request_presigned_url_response import FileRequestPresignedUrlResponse as FileRequestPresignedUrlResponseSchema

from upload_thing_python_sdk.type.err_bad_request import ErrBadRequest
from upload_thing_python_sdk.type.file_request_presigned_url404_response import FileRequestPresignedUrl404Response
from upload_thing_python_sdk.type.err_internal_server_error import ErrInternalServerError
from upload_thing_python_sdk.type.file_request_presigned_url_response import FileRequestPresignedUrlResponse
from upload_thing_python_sdk.type.err_unauthorized import ErrUnauthorized
from upload_thing_python_sdk.type.file_request_presigned_url_request import FileRequestPresignedUrlRequest
...
from upload_thing_python_sdk.pydantic.file_request_presigned_url_request import FileRequestPresignedUrlRequest as FileRequestPresignedUrlRequestPydantic
from upload_thing_python_sdk.pydantic.err_bad_request import ErrBadRequest as ErrBadRequestPydantic
from upload_thing_python_sdk.pydantic.file_request_presigned_url_response import FileRequestPresignedUrlResponse as FileRequestPresignedUrlResponsePydantic
from upload_thing_python_sdk.pydantic.file_request_presigned_url404_response import FileRequestPresignedUrl404Response as FileRequestPresignedUrl404ResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = FileRequestPresignedUrlRequestSchema


request_body_file_request_presigned_url_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = FileRequestPresignedUrlResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FileRequestPresignedUrlResponse
...
SchemaFor404ResponseBodyApplicationJson = FileRequestPresignedUrl404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: FileRequestPresignedUrl404Response
...
class BaseApi(api_client.Api):
    ...
    def _request_presigned_url_mapped_args(
        self,
        ...
        if file_key is not None:
            _body["fileKey"] = file_key
        if custom_id is not None:
            _body["customId"] = custom_id
        if expires_in is not None:
            _body["expiresIn"] = expires_in
        args.body = _body
    ...
    async def _arequest_presigned_url_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/requestFileAccess',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_file_request_presigned_url_request.serialize(body, content_type)
    ...
    def _request_presigned_url_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class RequestPresignedUrlRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arequest_presigned_url(
        self,
        x_uploadthing_version: str,
        file_key: typing.Optional[str] = None,
        custom_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._request_presigned_url_mapped_args(
        ...
        return await self._arequest_presigned_url_oapg(
            body=args.body,
    ...
    def request_presigned_url(
        ...
        return self._request_presigned_url_oapg(
            body=args.body,
            header_params=args.header,
        )

class RequestPresignedUrl(BaseApi):
    ...
    async def arequest_presigned_url(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FileRequestPresignedUrlResponsePydantic:
        raw_response = await self.raw.arequest_presigned_url(
            x_uploadthing_version=x_uploadthing_version,
            file_key=file_key,
            custom_id=custom_id,
            expires_in=expires_in,
        ...
        if validate:
            return FileRequestPresignedUrlResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FileRequestPresignedUrlResponsePydantic, raw_response.body)
    ...
    def request_presigned_url(
        ...
        raw_response = self.raw.request_presigned_url(
            x_uploadthing_version=x_uploadthing_version,
            file_key=file_key,
            custom_id=custom_id,
            expires_in=expires_in,
