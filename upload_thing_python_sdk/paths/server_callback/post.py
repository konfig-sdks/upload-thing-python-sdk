...
from upload_thing_python_sdk.model.server_callback_set_data_response import ServerCallbackSetDataResponse as ServerCallbackSetDataResponseSchema
...
from upload_thing_python_sdk.model.server_callback_set_data_request import ServerCallbackSetDataRequest as ServerCallbackSetDataRequestSchema
...
from upload_thing_python_sdk.type.server_callback_set_data_request import ServerCallbackSetDataRequest
...
from upload_thing_python_sdk.type.server_callback_set_data_response import ServerCallbackSetDataResponse
...
from upload_thing_python_sdk.pydantic.server_callback_set_data_response import ServerCallbackSetDataResponse as ServerCallbackSetDataResponsePydantic
from upload_thing_python_sdk.pydantic.server_callback_set_data_request import ServerCallbackSetDataRequest as ServerCallbackSetDataRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ServerCallbackSetDataRequestSchema


request_body_server_callback_set_data_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ServerCallbackSetDataResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ServerCallbackSetDataResponse
...
class BaseApi(api_client.Api):
    ...
    def _set_data_mapped_args(
        self,
        file_key: str,
        x_uploadthing_version: str,
        callback_data: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = None,
    ...
    async def _aset_data_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_server_callback_set_data_request.serialize(body, content_type)
...
class SetDataRaw(BaseApi):
    ...
    async def aset_data(
        ...
        **kwargs,
        ...
        args = self._set_data_mapped_args(
            file_key=file_key,
        ...
        return await self._aset_data_oapg(
            body=args.body,
    ...
    def set_data(
        ...
        return self._set_data_oapg(
            body=args.body,
            header_params=args.header,
        )

class SetData(BaseApi):
    ...
    async def aset_data(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ServerCallbackSetDataResponsePydantic:
        raw_response = await self.raw.aset_data(
            file_key=file_key,
            x_uploadthing_version=x_uploadthing_version,
            callback_data=callback_data,
            x_uploadthing_fe_package=x_uploadthing_fe_package,
        ...
        if validate:
            return ServerCallbackSetDataResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ServerCallbackSetDataResponsePydantic, raw_response.body)
    ...
    def set_data(
        ...
        raw_response = self.raw.set_data(
            file_key=file_key,
            x_uploadthing_version=x_uploadthing_version,
            callback_data=callback_data,
            x_uploadthing_fe_package=x_uploadthing_fe_package,
