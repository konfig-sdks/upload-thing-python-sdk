...
class RequiredErrUnauthorized(TypedDict):
    # A stringified version of the error
    error: str

class OptionalErrUnauthorized(TypedDict, total=False):
    # Additional data related to the error
    data: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

class ErrUnauthorized(RequiredErrUnauthorized, OptionalErrUnauthorized):
    pass
