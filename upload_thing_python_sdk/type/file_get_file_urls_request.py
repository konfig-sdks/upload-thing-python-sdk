...
class RequiredFileGetFileUrlsRequest(TypedDict):
    pass

class OptionalFileGetFileUrlsRequest(TypedDict, total=False):
    files: FileGetFileUrlsRequestFiles

    fileKeys: FileGetFileUrlsRequestFileKeys

    customIds: FileGetFileUrlsRequestCustomIds

class FileGetFileUrlsRequest(RequiredFileGetFileUrlsRequest, OptionalFileGetFileUrlsRequest):
    pass
