...
class RequiredFileListFilesRequest(TypedDict):
...
class OptionalFileListFilesRequest(TypedDict, total=False):
    pass

class FileListFilesRequest(RequiredFileListFilesRequest, OptionalFileListFilesRequest):
    pass
